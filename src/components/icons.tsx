...
/**
 * Local SVG icons. Emoji-as-icon is a design anti-pattern (font-dependent,
 * uncontrollable), so anything structural lives here with a consistent
...
export function SkullIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2a9 9 0 0 0-9 9c0 2.8 1.3 4.6 3 5.7V20a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-3.3c1.7-1.1 3-2.9 3-5.7a9 9 0 0 0-9-9Z" />
      <circle cx="9" cy="11" r="1.6" fill="currentColor" stroke="none" />
      <circle cx="15" cy="11" r="1.6" fill="currentColor" stroke="none" />
      <path d="M10 21v-2M14 21v-2M12 15v2" />
    </svg>
  );
}
